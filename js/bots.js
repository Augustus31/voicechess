const bots = {
  ...
  'DrPi': {
    ...
    description: 'You are playing a fairly easy bot. Beat him up.',
    time: 0,
    depth: 2,
    book: [
      'e2e4 c7c5 c2c3',
  ...
  'CMK': {
    ...
    description: 'You are playing the second hardest bot... maybe you will win!',
    time: 0,
    depth: 4,
    book: [
  ...
  'Wukong': {
    ...
    description: 'You are playing the hardest bot.... good luck!',
    time: 1,
    depth: 0,
    book: [
